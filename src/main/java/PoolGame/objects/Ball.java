...
public class Ball {
    ...
    /**
     * Forces a new value for attribute isActive
     *
     * @param status New status of isActive
     */
    ...
    /**
     * Getter method for the score value of the ball.
     *
     * @return the ball's score value.
     */
    public int getScore() {
        return score;
    }
    ...
    /**
     * Saves the latest state of the ball
     *
     * @return the new memento object
     */
    public BallMemento save() {
        return new BallMemento(isActive, xPosition, yPosition, strategy.getLives());
    }

    /**
     * Reverts the latest state of the ball
     *
     * @param memento The latest version of the ball
     */
    public void recover(BallMemento memento) {
        this.isActive = memento.getActive();
        this.strategy.setLives(memento.getLives());
        this.xPosition = memento.getX();
        this.yPosition = memento.getY();
        this.xVelocity = 0;
        this.yVelocity = 0;
    }
}
